...
function initAudioPlayer(){
  ...
  dir = "muzka/2000te/"; //folder gde je muzika
  playlist = ["Bojan Tomovic - Motorola","Danijela Vranic - Ne vidi ona","Darko Filipovic - Trebas mi","Zeljko Joksimovic - Varnice","Elma - Gradske price","Sanja Djordjevic - Crveni lak","Bojan Tomovic - S prijateljima na sto","Jami - One stvari","Maja Marijana - Napravicu lom","Maya - Dzin i limunada","Stoja - Evropa","Sanja Djordjevic - Poruci pesmu sa imenom mojim","Sanja Maletic - Mladji","Seka Aleksic - Crno i zlatno","Tanja Savic - Tako mlada","Sanja Maletic - S vremena na vreme","Slavica Cukteras - Zvaces je mojim imenom","Seka Aleksic - Za ljubav mobilna","Stoja - Potopicu ovaj splav","Tanja Savic - Zasto me u obraz ljubis","Viki - Maris li","Zeljko Joksimovic - Telo vreteno"];
  playlist_index = Math.floor(Math.random()*22);
  ext = ".mp3";
