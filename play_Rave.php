...
function initAudioPlayer(){
	...
	dir = "muzka/Rave/"; //folder gde je muzika
	playlist = ["Hilight Tribe - Esperanza","Armin Van Buuren & Vini Vici - Great Spirit (Droplex & Strong R. Bootleg)","Hilight Tribe - Free Tibet (Vini Vici Remix)","Armin van Buuren vs Vini Vici feat. Hilight Tribe - Great Spirit (Extended Mix)","Sam Paganini - Rave","D-DEVILS - 6TH GATE","Orca - Sad Movies","Gianny Of The Bells - Hammerers","Coming Soon   Its On Bouncerz","Freedom Fighters - Wasteland"];
	playlist_index = Math.floor(Math.random()*9);
	ext = ".mp3";
