...
function initAudioPlayer(){
	...
	dir = "muzka/Rock/"; //folder gde je muzika
	playlist = ["Alphaville - Forever Young","Beatles - The sound of silence","Bon Jovi - Always","Duran Duran - Come Undone","Beatles - Yesterday","Eric - Clapton","Guns N Roses - Knockin on Heavens Door","John Lennon - Imagine - Lyrics","Nirvana - Smells Like Teen Spirit","Guns N Roses - Sweet Child O Mine","Queen - Bohemian Rhapsody","Red Hot Chili Peppers - By The Way","Scorpions - No one like you","Sting - Englishman In New York","Queen - I Want To Break Free","Red Hot Chili Peppers - Otherside","Scorpions - Send Me An Angel","The Cranberries - Zombie", "Queen -The Show Must Go On","Red Hot Chili Peppers - Snow","Scorpions - Wind Of Change","The Police - Every Breath You Take","Oasis - Wonderwall"];
	playlist_index = Math.floor(Math.random()*21);
	ext = ".mp3";
